...
const Step2 = ({ userObject, handleExperienceChange, handleDescriptionChange, addExperience, addDescription, removeDescription }) => {
                    ...
                    {exp.description.map((desc, descIndex) => (
                        <div key={descIndex} className='description-item'>
                            <InputItem
                                ...
                                value={desc}
                            />
                            <button type='button' onClick={() => removeDescription(index, descIndex)}>Remove</button>
                        </div>
                    ))}
